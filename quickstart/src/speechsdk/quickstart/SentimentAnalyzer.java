...
class Doc {
    ...
    public Doc(String id, String language, String text){
        this.id = id;
...
class Docs {
	...
	public void add(String id, String language, String text) {
	    this.documents.add (new Doc (id, language, text));
	}
}
...
// Replace the accessKey string value with your valid access key.
	static String accessKey = "b8832adf5def454d9c621b41b2ed7369";
...
// a free trial access key, you should not need to change this region.
	...
	public static String getTheSentiment (Docs documents) throws Exception {
	...
	public String getSentiment(String text) throws Exception {
		Docs docs = new Docs();
		docs.add ("1", "en", text);
		String response = getTheSentiment (docs);
