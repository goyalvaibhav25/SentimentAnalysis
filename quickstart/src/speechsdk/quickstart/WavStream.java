...
public class WavStream extends PullAudioInputStreamCallback {
	...
	public InputStream parseWavHeader(InputStream reader) throws IOException {
		...
		ThrowIfFalse((numRead == 4) && (data[0] == 'R') && (data[1] == 'I') && (data[2] == 'F') && (data[3] == 'F'),
				"RIFF");
		...
		ThrowIfFalse((numRead == 4) && (data[0] == 'W') && (data[1] == 'A') && (data[2] == 'V') && (data[3] == 'E'),
				"WAVE");

		// Tag: "fmt"
		numRead = reader.read(data, 0, 4);
		ThrowIfFalse((numRead == 4) && (data[0] == 'f') && (data[1] == 'm') && (data[2] == 't') && (data[3] == ' '),
				"fmt ");
		...
		// tag: data.
		numRead = reader.read(data, 0, 4);
		ThrowIfFalse((numRead == 4) && (data[0] == 'd') && (data[1] == 'a') && (data[2] == 't') && (data[3] == 'a'),
				"data");
